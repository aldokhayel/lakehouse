// DestinationNode.tsx — Custom React Flow node for Iceberg table destinations with only a target (input) handle.
'use client'
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div>
          <div style={{ color: '#e2e8f0', fontSize: 13, fontWeight: 600 }}>
            {(data.label as string) || 'Iceberg Table'}
          </div>
          <div style={{ color: '#64748b', fontSize: 11, marginTop: 2 }}>DESTINATION</div>
        </div>
      </div>
